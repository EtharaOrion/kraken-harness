def test_workflow_0425_service_lifecycle(cli, kubectl_bin, tmp_path, k8s_client):
    ...
    r_get = cli("get", "service", "wf-svc-0425", "-n", "default", "-o", "yaml")
    assert r_get.returncode == 0, r_get.stderr
    r_desc = cli("describe", "service", "wf-svc-0425", "-n", "default")
    assert r_desc.returncode == 0, r_desc.stderr
    r_del = cli("delete", "service", "wf-svc-0425", "-n", "default")
