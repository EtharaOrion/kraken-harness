#!/usr/bin/env bash
#
# 10-july-v4 DDB batch: same 10 subset shapes as v1/v2, but with
...
# Env (optional):
#   OUT_ROOT             parent dir (default: ./datasets/v4)
...
echo
echo "[10-july-v4] batch complete. Task dirs under: $OUT_ROOT/ddb-v4-t{1..10}/"
