#!/usr/bin/env bash
#
# 10-july-v1 DDB batch: reproduce the v3 subset shapes with the samples-format
# emitter and the aws_cli_dynamodb task_env base image. Each subset emits into
# its own ./datasets/ddb-v4-t{N}/ dir for failure isolation.
#
# Env (required):
...
# Env (optional):
#   OUT_ROOT             parent dir for ddb-v4-t*/ (default: ./datasets)
...
echo
echo "[10-july-v1] batch complete. Task dirs under: $OUT_ROOT/ddb-v4-t{1..10}/"
